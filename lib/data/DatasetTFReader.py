...
from lib.constants.Constants import Constants as constants
from lib.image.ImageUtilsTF import ImageUtilsTF
...
class DatasetTFReader(DatasetReader):
    ...
    def readTFExamplesTraining(self):
        return self.readTFExamples(tfrecordsFile=os.path.join(self.datasetDir, "data_train.tfrecords"), shuffle=False)
